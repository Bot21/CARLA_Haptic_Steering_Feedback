...
toggle_line = True # If True, displays trajectory line during overtakes. If False, it does not
...
OBSTACLE_FORMATION = 'long_overtake'

formation_spawn = True #If True, obstacles spawn in a specific formation, else, they spawn randomly

SPAWN_INDEX = 25 #Specific index to select Ego vehicle spawn from list of available points
...
def back_control_update(world, frontvehicle, backvehicle, back_controller, logi_controller, changing_lane):
    ...
    if len(coordinate_queue) == 0:
        ...
        '''
        The following section of code that calculates offsets and errors
...
def spawnObstacles(world, actor_list, spawn_points, obstacle_bp):
    ...
    print('Numbner of obstacles: ' + str(num_obstacles))
